...
export const register = catchAsyncErrors(async (req, res, next) => {
    ...
    if (!cloudinaryResponseForAvatar || cloudinaryResponseForAvatar.error) {
        console.error(
            "Cloudinary Error:",
            cloudinaryResponseForAvatar.error || "Unknown Cludinary Error"
        );
    }
    ...
    if (!cloudinaryResponseForResume || cloudinaryResponseForResume.error) {
        console.error(
            "Cloudinary Error:",
            cloudinaryResponseForResume.error || "Unknown Cludinary Error"
        );
    }
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
    const id = "667d754f654d3176f7c0dc7c";
...
export const resetPassword = catchAsyncErrors(async (req, res, next) => {
    ...
    if(req.body.password !== req.body.confirmPassword){
        return next(new ErrorHandler("Password & Confirm Password Do Not Match",302));
    }
